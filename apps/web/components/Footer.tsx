        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              AI-powered real estate investment analysis that gives you the insights you need to make smarter property decisions nationwide.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-xs leading-5 text-gray-500">
              &copy; 2024 PropertyAI Pro. All rights reserved.
            </p>
            <p className="text-xs leading-5 text-gray-500 mt-4 sm:mt-0">
              Real estate data powered by Estated API. AI analysis by Claude 3 Haiku.
            </p>
          </div>
        </div>
      </div>
